...
import { Brain, Clock, Home, Settings2, Zap } from "lucide-react";
...
interface ModeSelectorProps {
  ...
  onSelectReviewPractice: () => void;
  onRenderCustomConfig: () => React.ReactNode;
}

export function ModeSelector({
  reviewStats,
  onSelectQuickPractice,
  onSelectReviewPractice,
  onRenderCustomConfig
}: ModeSelectorProps) {
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          {reviewStats && reviewStats.total_due > 0 && (
            <Card
              ...
              onClick={onSelectReviewPractice}
            >
              <CardHeader>
          ...
          <Card className="cursor-pointer hover:border-primary transition-colors" onClick={onSelectQuickPractice}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
